var productList = [
  ...
  function createList(array, id) {
    const listContainer = document.querySelector(`#${id} > .products-list`);
...
function getProductData(){
   ...
   const productDetails = productList.find((i)=>i.id===productId); // make an api call while working for poject
   ...
   if(productDetails){
    ...
    const {name,photos,preview, price:productPrice,brand:productBrand,description:desc} = productDetails;
